...
module "security" {
  ...
  # Enable stricter WAF rules in production
  waf_block_mode           = "BLOCK"
...
module "database" {
  ...
  rds_multi_az       = true  # Always use multi-AZ in production
  ...
  redis_multi_az      = true  # Always use multi-AZ in production
